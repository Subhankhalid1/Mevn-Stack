    ...
    <div class="container-fluid h-100 py-5" style=" width: 76%;">
      ...
      >
        <div class="col-12">
          ...
          <div class="col-12" v-for="Items in allCartProducts" :key="Items._id">

          <div class="card rounded-3 mb-4" v-for="cartItem in Items.products">
         {{ cartItem }}
            <div class="card-body p-4">
              ...
              >
                ...
                <div class="col-md-3 col-lg-3 col-xl-3">
                  <p class="lead fw-normal mb-2">{{ cartItem?.product.product_name }}</p>
                  <p>
                    <span class="text-muted">Category Name :</span>
                    <span class="text-muted"> </span
                    >{{ cartItem?.product?.category_name?.category }}
                  </p>
                </div>
                <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                  ...
                  >
                    <font-awesome-icon icon="fa-solid fa-minus" class="fa-2x" />
                  </button>
                  <span class="py-2 px-3 border">{{ cartItem.product?.quantity }}</span>
                  ...
                  >
                    <font-awesome-icon icon="fa-solid fa-plus" class="fa-2x" />
                  </button>
                </div>
                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                  <h5 class="mb-0">{{ cartItem.product?.product.price }}</h5>
                </div>
                <div
